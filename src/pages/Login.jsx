...
// Purple palette derived from loading screen bgPurple (#393185)
const bg       = "#393185"   // base — same as loading screen
const surface  = "#453D9A"   // slightly lighter for panels/sidebar
const cardBg   = "#4F479F"   // lighter still for inner card / hover
...
export default function Login() {
  ...
  const handleLogin = (e) => {
    e.preventDefault()
    setLoading(true)
    setTimeout(() => { setLoading(false); navigate("/loading") }, 800)
  }
          ...
          >
            <div>
              ...
              <h1 style={{
                ...
                lineHeight: typography.tight_line,
              ...
              <div className="space-y-2.5 mb-8">
                {features.map((feature, i) => (
                  ...
                  >
                    ...
                    <p style={{ color: textSub, fontSize: typography.xs, lineHeight: typography.relaxed }}>
                      {feature}
                    </p>
                  </motion.div>
                ))}
            ...
            <div>
              ...
              >
                {stats.map((stat, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="flex-1 flex flex-col items-start px-4 first:pl-0"
                      style={{ borderRight: i < stats.length - 1 ? `1px solid ${border}` : "none" }}
                    >
                      <div className="flex items-center gap-1.5 mb-0.5">
                        <Icon size={12} style={{ color: colors.accent }} strokeWidth={2} />
                        <p style={{ color: textOn, fontSize: typography.xl, fontWeight: typography.bold }}>
                          {stat.value}
                        </p>
                      </div>
              ...
              <motion.p
                ...
                style={{ color: textFade, fontSize: typography.xs, marginTop: "1rem" }}
              >
      ...
      <div className="relative w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-8 py-8 min-h-screen lg:min-h-0">
        ...
        >
          ...
          <motion.div
            ...
            className="flex flex-col items-center mb-7 lg:hidden"
          >
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <Mail size={15} className="absolute left-4 top-1/2 -translate-y-1/2"
                  style={{ color: focused === "email" ? colors.accent : textSub }} />
                <input
                  type="email"
                  value={email}
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <a href="#" style={{ color: colors.accent, fontSize: typography.xs, fontWeight: typography.medium }}>
                  Forgot?
                </a>
              </div>
              <div className="relative">
                <Lock size={15} className="absolute left-4 top-1/2 -translate-y-1/2"
                  style={{ color: focused === "password" ? colors.accent : textSub }} />
                <input
