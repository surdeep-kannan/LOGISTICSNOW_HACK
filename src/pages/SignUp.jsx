...
import { Mail, Lock, Eye, EyeOff, ArrowRight, User, Building2, Zap, BarChart3, Globe } from "lucide-react"
          ...
          >
            <div>
              ...
              <h1 style={{
                ...
                Start Shipping.
                <br />Smarter & Faster.
                <br /><span style={{ color: colors.accent }}>With AI.</span>
              </h1>
              ...
              <div key={name}>
                ...
                <div className="relative">
                  <Icon size={15} className="absolute left-4 top-1/2 -translate-y-1/2"
                    style={{ color: focused === name ? colors.accent : textSub }} />
                  <input
                    type={type}
                    name={name}
                    value={form[name]}
